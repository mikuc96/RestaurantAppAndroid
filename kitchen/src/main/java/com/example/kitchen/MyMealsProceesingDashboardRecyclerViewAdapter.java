 ...
 */
public class MyMealsProceesingDashboardRecyclerViewAdapter extends RecyclerView.Adapter<MyMealsProceesingDashboardRecyclerViewAdapter.ViewHolder> {

    private final List<DummyItem> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MyMealsProceesingDashboardRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
